...
define(["dojo/_base/lang",
	...
	application.createCommonShowDialog = function(id,src,args){
        var obj = {src:src};
        if(args){
        ...
        if(rosten[id]) rosten[id].destroy();
        rosten[id] = new ShowDialog(obj);
        return rosten[id];
    },
    application.hideCommonShowDialog = function(id){
        if (rosten[id]){
            rosten[id].hide();
            rosten[id].destroy();
        }
    ...
    application.createRostenShowDialog = function(src,args){
        ...
        if(rosten.rostenShowDialog) rosten.rostenShowDialog.destroy();
        rosten.rostenShowDialog = new ShowDialog(obj);
    },
    application.hideRostenShowDialog = function(){
        if (rosten.rostenShowDialog){
        	rosten.rostenShowDialog.hide();
        	rosten.rostenShowDialog.destroy();
        }
    },
