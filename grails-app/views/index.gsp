		...
		<div data-dojo-type="dijit/layout/BorderContainer" id="home"
			...
			<div data-dojo-type="dojox/layout/ContentPane" id="home_center"
				data-dojo-props='region:"center",executeScripts:true,renderStyles:true,style:"padding:1px"'>
					...
					<div data-dojo-type="dijit/layout/BorderContainer" data-dojo-props='gutters:false,style:{height:"422px"}' >
					
						<div data-dojo-type="rosten/widget/TitlePane" id="home_gtask"
							data-dojo-props='region:"left",title:"待办工作",toggleable:false,
								height:"372px",width:"50%",style:{marginRight:"1px"},
								_moreClick:more_gtask,moreText:"更多"'>
						</div>
						<div data-dojo-type="dijit/layout/BorderContainer" data-dojo-props='gutters:false,style:{height:"415px"},region:"center"' >
							<div data-dojo-type="rosten/widget/TitlePane" id="home_bbs"
								data-dojo-props='region:"top",title:"最新公告",toggleable:false,
									height:"203px",
									_moreClick:more_bbs,moreText:"更多"'>
							</div>
							<div data-dojo-type="rosten/widget/TitlePane"
								data-dojo-props='region:"center",title:"工作日志",toggleable:false,style:{marginTop:"1px"},
									height:"120px",_moreClick:more_workLog,moreText:"更多"'>
									
								<div class="por-mod" style="padding:0px"> 
								<!--计划-->
									<div class="por-jh">
